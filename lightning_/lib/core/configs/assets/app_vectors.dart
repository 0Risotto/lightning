class AppVectors {
  ...
  //static const String logo = '${basePath}lightning_logo3$format';
  //2static const String logo = '${basePath}spotify_logo$format';

  static const String logo = '${basePath}lightning_logo_final$format';
